...
group :al_folio_plugins do
    gem "al_folio_core", git: "https://github.com/rpornmon/rp-folio-core.git", branch: "main"
    gem 'al_icons', '= 1.0.0'
    gem 'al_folio_cv', git: "https://github.com/rpornmon/rp-folio-cv.git", branch: "main"
